...
<head>
    ...
    <script src="5026221183_JS.js"></script>
</head>
...
<body>
    ...
    <div class="centerContent">
        <div class="formValid layerSeparator">
            <form action="https://www.mncvision.id" method="get" target="_self" onsubmit="return submit();">
                ...
                <div>
                    <input type="submit" class="submitStyle" value="submit">
                </div>
            </form>
        </div>
    </div>
